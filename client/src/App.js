...
import EmployeeProfilePage from './components/HR Dashboard/Employee/Employee Profile/EmployeeProfilePage.jsx';
import ApplicantProfile from './components/HR Dashboard/Hiring/Job Applications/ApplicantProfile.jsx';
  ...
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@600&display=swap" rel="stylesheet" />
      ...
      {loading ? (
        ...
        <Routes>
          ...
          <Route path="/hrdash/manageEmployee/employeeProfile" element={<EmployeeProfilePage />} />
          <Route path="/hrdash/viewApplications/applicantProfile" element={<ApplicantProfile />} />
