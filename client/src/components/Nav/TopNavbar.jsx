...
export default function TopNavbar() {
  ...
  return (
    <>
      ...
      <Wrapper className="flexCenter animate whiteBg" style={y > 100 ? { height: "75px" } : { height: "80px" }}>
        <NavInner className="container flexSpaceCenter">
          <ScrollLink className="pointer flexNullCenter" to="home" smooth={true}>
            {/* <LogoIcon /> */}
            <img src={hrconnect} alt="logo" height={75} width={75} style={{ marginLeft: "15px" }} className="font20 extraBold" />
