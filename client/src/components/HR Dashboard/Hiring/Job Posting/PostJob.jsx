  ...
  return (
    <div id="full-content">
      ...
      <div id="content">
        ...
        <Row className={`mb-2 ${styles.slideIn}`} style={{ display:'flex', justifyContent:'space-around' ,marginTop: '10px', marginBottom: '10px' }}>
        ...
        <Row className={`mb-3 mt-3 ${styles.slideIn}`}>
        ...
        <table style={{textAlign:'center'}} className={`table ${styles.table}`}>
          <thead>
            <tr style={{ borderBottom: '3px solid white', fontSize:"18px", fontWeight:'bolder'}}>
              <th>Job Title</th>
              <th>Department</th>
