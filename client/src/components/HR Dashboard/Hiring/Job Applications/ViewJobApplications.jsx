...
muhammadihtisham269@gmail.com`);
  ...
  return (
    <div id="full-content" className="container mt-2">
      ...
      <div id="content">
        ...
        <Table style={{textAlign:'center'}} striped bordered hover responsive className="custom-scrollbar-table">
          <thead>
            ...
            {currentApplications
              .map((application) => (
                ...
                {/*  <td>{application.application_id}</td>  */}
                  <td><div style={{ width: '120px' }}>{application.applicant_name}</div></td>
                  <td><div style={{ width: '150px' }}>{application.dep_name}</div></td>
                ...
                <Button
                  variant="primary"
                  size="sm"
                  onClick={() => navigate(`/hrdash/viewApplications/applicantProfile`, { state: { application : application } })}
                >
                  View Profile
                </Button>
              </td>
