...
export default function ViewProfile() {
  ...
  const handleChangePassword = (e) => {
    ...
    console.log(current, confirm, newPass)

    try {
      const response = axios.put(BaseUrl+'/resetPassword', {current, confirm, newPass})
  ...
  return (
    <>
      {password ? (
        <>
          <form>
            <input type="text" name="current" value={current} onChange={(e)=>setCurrent(e.target.value)}/>
            <input type="text" name="newPass" value={newPass} onChange={(e)=>setNewPass(e.target.value)}/>
